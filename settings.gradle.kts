...
rootProject.name = "config-root"
include("config")

//examples
include("examples:java:simple-lib")
include("examples:java:simple-app")
include("examples:java:complex-app")

include("testlib-resource-hack")
