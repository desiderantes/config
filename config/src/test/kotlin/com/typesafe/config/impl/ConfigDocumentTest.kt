...
class ConfigDocumentTest : TestUtils() {
	@Test
	fun configDocumentReplace() {
	...
	@Test
	fun configDocumentMultiElementDuplicatesRemoved() {
	...
	@Test
	fun configDocumentSetNewValueBraceRoot() {
		val origText = "{\n\t\"a\":\"b\",\n\t\"c\":\"d\"\n}"
		val finalTextConf = "{\n\t\"a\":\"b\",\n\t\"c\":\"d\"\n\t\"e\" : \"f\"\n}"
		val finalTextJson = "{\n\t\"a\":\"b\",\n\t\"c\":\"d\",\n\t\"e\" : \"f\"\n}"
	...
	@Test
	fun configDocumentSetNewValueNoBraces() {
		val origText = "\"a\":\"b\",\n\"c\":\"d\"\n"
		val finalText = "\"a\":\"b\",\n\"c\":\"d\"\n\"e\" : \"f\"\n"
	...
	@Test
	fun configDocumentSetNewValueMultiLevelConf() {
		val origText = "a:b\nc:d"
		val finalText = "a:b\nc:d\ne : {\n  f : {\n    g : 12\n  }\n}"
	...
	@Test
	fun configDocumentSetNewValueMultiLevelJson() {
		val origText = "{\"a\":\"b\",\n\"c\":\"d\"}"
		val finalText = "{\"a\":\"b\",\n\"c\":\"d\",\n  \"e\" : {\n    \"f\" : {\n      \"g\" : 12\n    }\n  }}"
	...
	@Test
	fun configDocumentRemoveValueJSON() {
		val origText = """{"a": "b", "c": "d"}"""
		val configDoc =
			ConfigDocumentFactory.parseString(origText, ConfigParseOptions.defaults().setSyntax(ConfigSyntax.JSON))
	...
	@Test
	fun configDocumentRemoveMultiple() {
	...
	@Test
	fun configDocumentRemoveOverridden() {
	...
	@Test
	fun configDocumentRemoveNested() {
		val origText = "a { b: 42 }, a.b = 43, a { b: { c: 44 } }"
		val configDoc = ConfigDocumentFactory.parseString(origText)
	...
	@Test
	fun configDocumentArrayFailures() {
		...
		val e1 = assertThrows(ConfigException::class.java) {
			document.withValueText("a", "1")
		}
		assertTrue(e1.message!!.contains("ConfigDocument had an array at the root level"))

		val e2 = assertThrows(ConfigException::class.java) {
			document.hasPath("a")
		}
		assertTrue(e2.message!!.contains("ConfigDocument had an array at the root level"))

		val e3 = assertThrows(ConfigException::class.java) {
			document.withoutPath("a")
		}
		assertTrue(e3.message!!.contains("ConfigDocument had an array at the root level"))
	}

	@Test
	fun configDocumentJSONReplaceFailure() {
		...
		assertTrue(e.message!!.contains("Token not allowed in valid JSON"))
	}

	@Test
	fun configDocumentJSONReplaceWithConcatenationFailure() {
	...
	@Test
	fun configDocumentFileParse() {
		val configDocument = ConfigDocumentFactory.parseFile(resourceFile("/test03.conf"))
		val fileReader = BufferedReader(FileReader("src/test/resources/test03.conf"))
	...
	@Test
	fun configDocumentReaderParse() {
		val configDocument = ConfigDocumentFactory.parseReader(FileReader(resourceFile("/test03.conf")))
	...
	@Test
	fun configDocumentIndentationSingleLineObject() {
	...
	@Test
	fun configDocumentIndentationMultiLineObject() {
		var origText = "a {\n  b: c\n}"
		var configDocument = ConfigDocumentFactory.parseString(origText)
	...
	@Test
	fun configDocumentIndentationNested() {
	...
	@Test
	fun configDocumentIndentationEmptyObject() {
		var origText = "a { }"
		var configDocument = ConfigDocumentFactory.parseString(origText)
	...
	@Test
	fun configDocumentIndentationMultiLineValue() {
		val origText = "a {\n  b {\n    c {\n      d: e\n    }\n  }\n}"
	...
	@Test
	fun configDocumentIndentationMultiLineValueSingleLineObject() {
	...
	@Test
	fun configDocumentIndentationSingleLineObjectContainingMultiLineValue() {
		val origText = "a { b {\n  c: d\n} }"
		val configDocument = ConfigDocumentFactory.parseString(origText)
	...
	@Test
	fun configDocumentIndentationReplacingWithMultiLineValue() {
		var origText = "a {\n  b {\n    c : 22\n  }\n}"
		var configDocument = ConfigDocumentFactory.parseString(origText)
	...
	@Test
	fun configDocumentIndentationValueWithInclude() {
		val origText = "a {\n  b {\n    c : 22\n  }\n}"
		val configDocument = ConfigDocumentFactory.parseString(origText)
	...
	@Test
	fun configDocumentIndentationBasedOnIncludeNode() {
		val origText = "a : b\n      include \"foo\"\n"
		val configDocument = ConfigDocumentFactory.parseString(origText)
	...
	@Test
	fun configDocumentEmptyTest() {
		val origText = ""
		val configDocument = ConfigDocumentFactory.parseString(origText)

		assertEquals("a : 1", configDocument.withValueText("a", "1").render())

		val mapVal = ConfigValueFactory.fromAnyRef(mapOf("a" to 1, "b" to 2))
		assertEquals(
			"a : {\n    \"a\" : 1,\n    \"b\" : 2\n}",
			configDocument.withValue("a", mapVal).render()
		)

		val arrayVal = ConfigValueFactory.fromAnyRef(listOf(1, 2))
		assertEquals("a : [\n    1,\n    2\n]", configDocument.withValue("a", arrayVal).render())
	}

	@Test
	fun configDocumentConfigObjectInsertion() {
		val origText = "{ a : b }"
		val configDocument = ConfigDocumentFactory.parseString(origText)

		val configVal = ConfigValueFactory.fromAnyRef(mapOf("a" to 1, "b" to 2))
	...
	private fun configDocumentReplaceJsonTest(
		origText: String,
		finalText: String,
		newValue: String,
		replacePath: String
		...
		assertTrue(newDocument is SimpleConfigDocument)
		assertEquals(finalText, newDocument.render())
	}

	private fun configDocumentReplaceConfTest(
		origText: String,
		finalText: String,
		newValue: String,
		replacePath: String
	...
	private fun defaultLineEndingsToUnix(s: String): String = s.replace(System.lineSeparator(), "\n")
}
